...
plot    'table.csv' using 1:2 with linespoints title "H1" lw 4 ps 0 lt rgb PVS, \
	...
	NaN with linespoints title "H3" dt 2 lw 4 ps 0 lt rgb LOOP, \
	NaN with linespoints title "H4" dt 2 lw 4 ps 0 lt rgb 'green', \
...
set xlabel '{/Helvetica:Bold Time (s)}'
set label '{/Helvetica:Bold Throughput (Mbps)}' at -3,36 rotate by 90
plot 'table.csv' using 1:4 with linespoints notitle "H3" dt 2 lw 4 ps 0 lt rgb LOOP, \
	'table.csv' using 1:5 with linespoints notitle "H4" dt 2 lw 4 ps 0 lt rgb 'green', \
	NaN with lines notitle "Request" dt 2 lw 4 lt rgb 'black', \
	NaN with lines notitle "Reconfig" dt 3 lw 4 lt rgb 'gray'
